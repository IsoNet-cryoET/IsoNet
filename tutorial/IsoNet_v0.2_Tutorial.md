...
3. [Individual tasks](#3-individual-tasks)
    ...
    * [3.3 Generate mask](#33-generate-mask)
        ...
        * [3.3.3 Draw a polygon to define area of interest](#33-draw-a-polygon-to-define-area-of-interest)
    ...
    * [3.5 Refine](#35-refine)
        ...
        * [3.5.2 Optimizing training speed](#351-optimizing-training-speed)
        * [3.5.3 Denoising](#341-denoising)
        * [3.5.4 Network structures](#354-network-structures)
