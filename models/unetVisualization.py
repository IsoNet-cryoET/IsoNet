...
model = keras.models.load_model('/home/heng/mwr/test_data/real_data/model_27_12_1.h5')
print('Model loaded.')
...
layer_dict = dict([(layer.name, layer) for layer in model.layers[9].layers[1:]])
...
imsave('/home/heng/mwr/test_data/run_csbdeep/visualize', stitched_filters)
